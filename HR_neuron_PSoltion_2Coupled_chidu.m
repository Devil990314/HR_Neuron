...
%提取数据至txt
fid=fopen(['C:\Users\Asus\Desktop\Matlab_data\matlab_Coupled_chidu_data\1','C=10.txt'],'w');%写入文件路径
...
fclose(fid);
 ...
 fid=fopen(['C:\Users\Asus\Desktop\Matlab_data\matlab_Coupled_chidu_data\1','C=10_time.txt'],'w');%写入文件路径
